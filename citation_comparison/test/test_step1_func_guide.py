from citation_comparison.step1_func_guide import read_pwcjson
import pytest
import numpy as np
...
def test_file_load_missing_url_file():
    ...
    with pytest.raises(ValueError) as excinfo:
        read_pwcjson("./Test_data/non-existing_file.json",
...
def test_file_return_good():
    ...
    paper_code, paper_abs = read_pwcjson('./Test_data/urls.json',
                                         './Test_data/abstracts.json')
